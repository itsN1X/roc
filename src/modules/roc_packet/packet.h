...
public:
    ...
    //! @remarks
    //!  The returning value depends on packet type. For some packet type, may
    //!  be always zero.
    ...
    //! @returns
    //!  distance from the begining of this packet to the end of @p other packet,
    //!  measured in packet-specific time units.
    timestamp_t distance(const Packet& other) const;
